  ...
  return (
    <>
      ...
      <Link
        ...
        tabIndex={-1}
        aria-hidden="true"
        className="text-base font-semibold transition hover:text-zinc-600"
      >
        {page.title}
      </Link>
    </>
    ...
    <div className="flex">
      {previousPage && (
        <div className="flex flex-col items-start gap-3">
          <PageLink label="Về trước" page={previousPage} previous />
        </div>
      )}
      {nextPage && (
        <div className="ml-auto flex flex-col items-end gap-3">
          <PageLink label="Tiếp theo" page={nextPage} />
        </div>
      )}
    </div>
  )
